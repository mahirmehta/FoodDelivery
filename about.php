      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Welcome to <span>OMA Delivery</span></h2>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="assets/img/slide/slide-7.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate mb-0">A project by</h2><a href="https://github.com" target="_blank">Omkar Mahir Akhil</a></p>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Get Started</a>
              </div>
            </div>
          </div>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h3>Welcome to <strong>OMA Delivery</strong></h3>
            <h3><strong>The Leader in Quick Food Delivery</strong></h3>
            <p class="font-italic">
          </div>
    ...
    <section id="team" class="team">
      <div class="container">
        ...
        <div class="row" style="padding-left: 228px;">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.1s">
            <div class="member">
              ...
              <div class="member-info">
                ...
                <div class="social">
                  <a href="" target="_blank"><i class="icofont-twitter" target="_blank"></i></a>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.2s">
            <div class="member">
              <img src="assets/img/team/team3.jpg" class="img-fluid" alt="" style="height: 198px;width: 198px;">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Akhil Nagar</h4>
                </div>
